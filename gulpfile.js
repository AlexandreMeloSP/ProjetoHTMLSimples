...
// Compila arquivos SCSS de /scss para /css
...
// Copia arquivos de fornecedores de /node_modules para /vendor
// NOTA: requer `npm install` antes de executar!
...
// Configura a tarefa browserSync
...
// Tarefa dev com browserSync
gulp.task('dev', ['browserSync', 'sass', 'minify-css', 'minify-js'], function () {
  gulp.watch('scss/*.scss', ['sass']);
  gulp.watch('css/*.css', ['minify-css']);
  gulp.watch('js/*.js', ['minify-js']);
  // Recarrega o navegador sempre que arquivos HTML ou JS mudam
